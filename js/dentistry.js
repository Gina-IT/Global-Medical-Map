...
displayPagination(pagination_dentistry);
...
function displayPagination(pagination) {
    var paginationEl = document.getElementById('pagination_dentistry'),
        fragment = document.createDocumentFragment(),
        i; 
    ...
    for (i=1; i<=pagination.last; i++) {
        var el = document.createElement('a');     //html 요소 추가, <a> 태그 생성
        el.href = "#";   //현재 페이지 최상단으로 이동
        el.innerHTML = i;
